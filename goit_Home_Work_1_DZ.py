...
# Програмісти часто працюють із геоданими. Попрацюємо і ми з ними. 
# Нам необхідно написати програму, в якій ми розрахуємо відстань між двома точками на поверхні Землі.
...
# Широта lat2 = 51.5072
# Довгота lon2 = -0.1275
# Радіус Землі приймемо 6371.01 км. Відстань у кілометрах між містами з урахуванням викривленості планети 
...
# #Лондон Широта і Довгота в градусах
...
# розрахувати площу, але потрібно рядковий тип перетворити на чисельний (float) при отриманні значення через input.
# Змінну show створювати не треба.

# +++++++++++++++++Код/Code+++++++++++++++++++++++++++++++++++

# length = float(input("Введіть довжину  "))
# width = float(input("Введіть широну "))
# area = length*width
# print(f"Area = {area}")